...
public class ElectrolyteServiceImp {
  ...
  private final ConcurrentHashMap<String, Electrolyte> electrolyteEntityMap = new ConcurrentHashMap<>();

  public Flux<ElectrolyteView> getAllViewElectrolytes() {
    return Flux
        .fromIterable(electrolyteEntityMap.values())
  ...
  public Mono<String> getAllElectrolytesNames() {
    return Mono.just(String.join(",", electrolyteEntityMap.keySet()));
  }

  public Flux<Electrolyte> findAll() {
    return Flux.fromIterable(electrolyteEntityMap.values());
  }
